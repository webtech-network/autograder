...
def parse_html():
    # Construct the path to index.html in the request_bucket folder
    # test_base.py is in autograder/core/validation/
    # request_bucket/index.html is in autograder/request_bucket/
    html_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'autograder', 'request_bucket', 'submission','index.html')
...
def parse_css():
    # Construct the path to style.css in the request_bucket folder
    css_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'autograder', 'request_bucket','submission', 'style.css')
    with open(css_path, 'r',encoding="utf-8") as file:
        return file.read()

# Helper function to parse the JS file
def parse_js():
    # Construct the path to script.js in the request_bucket folder
    js_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'autograder', 'request_bucket','submission', 'script.js')
    with open(js_path, 'r',encoding="utf-8") as file:
        return file.read()
#TODO-> Generalize file picking and decouple it from test suites
