"""Criteria Tree module for building grading hierarchies."""

from typing import Any, List

from autograder.context import request_context  # noqa: F401
...
class TestCall:
    ...
    def __init__(self, args: List[Any]):
        """Initialize TestCall with arguments."""
        self.args = args

    def __repr__(self):
        """Return string representation of TestCall."""
...
class Criteria:
    ...
    def print_pre_executed_tree(self):
        ...
        print("🌲 Pre-Executed Criteria Tree")
        ...
        if subject.tests is not None:
            ...
            for result in subject.tests:
                if isinstance(result, TestResult):
                    ...
                    print(
                        f"{prefix}  - 📝 {result.test_name}{params_str} -> Score: {result.score}"
                    )
                else:
