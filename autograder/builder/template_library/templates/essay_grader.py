...
class ClarityAndCohesionTest(TestFunction):
    @property
    def name(self):
        return "clarity_and_cohesion"

    @property
    def description(self):
        return "Avalia a clareza geral e o fluxo do ensaio."
...
class GrammarAndSpellingTest(TestFunction):
    ...
    @property
    def description(self):
        return "Verifica o ensaio em busca de erros gramaticais, de ortografia e de pontuação."
...
class ArgumentStrengthTest(TestFunction):
    ...
    @property
    def description(self):
        return "Avalia a força e o suporte dos argumentos apresentados."
...
class ThesisStatementTest(TestFunction):
    ...
    @property
    def description(self):
        return "Avalia a clareza e a eficácia da declaração de tese."
...
class AdherenceToPromptTest(TestFunction):
    @property
    def name(self):
        return "adherence_to_prompt"

    @property
    def description(self):
        return "Verifica quão bem o ensaio aborda os requisitos específicos do tema proposto."

    @property
    def parameter_description(self):
        return {
            "essay_content": "O texto do ensaio a ser analisado.",
            "prompt_requirements": "O tema específico que o ensaio deveria abordar.",
        }
...
class OriginalityAndPlagiarismTest(TestFunction):
    @property
    def name(self):
        return "originality_and_plagiarism"

    @property
    def description(self):
        return "Uma verificação simplificada de originalidade procurando por frases comuns ou conteúdo copiado."
...
class TopicConnectionTest(TestFunction):
    ...
    @property
    def description(self):
        return "Verifica se o ensaio estabelece com sucesso uma conexão entre dois tópicos especificados."

    @property
    def parameter_description(self):
        return {
            "essay_content": "O texto do ensaio.",
            "topic1": "O primeiro tópico.",
            "topic2": "O segundo tópico.",
        }
...
class CounterargumentHandlingTest(TestFunction):
    ...
    def description(self):
        return (
            "Avalia quão bem o ensaio reconhece e refuta potenciais contra-argumentos."
        )
...
class IntroductionAndConclusionTest(TestFunction):
    @property
    def name(self):
        return "introduction_and_conclusion"

    @property
    def description(self):
        return "Avalia a eficácia da introdução e da conclusão do ensaio."
...
class EvidenceQualityTest(TestFunction):
    ...
    @property
    def description(self):
        return "Avalia a relevância e a qualidade das evidências usadas para apoiar as alegações."
...
class ToneAndStyleTest(TestFunction):
    ...
    @property
    def description(self):
        return "Avalia se o tom e o estilo de escrita do ensaio são apropriados para o tópico e o público."

    @property
    def parameter_description(self):
        return {
            "essay_content": "O texto do ensaio.",
            "expected_tone": "O tom esperado (ex: formal, persuasivo, objetivo).",
        }
...
class VocabularyAndDictionTest(TestFunction):
    @property
    def name(self):
        return "vocabulary_and_diction"

    @property
    def description(self):
        return "Avalia a sofisticação e a variedade do vocabulário utilizado."
...
class SentenceStructureVarietyTest(TestFunction):
    @property
    def name(self):
        return "sentence_structure_variety"

    @property
    def description(self):
        return "Verifica a presença de estruturas de frase variadas e complexas."
...
class BiasDetectionTest(TestFunction):
    ...
    @property
    def description(self):
        return "Identifica potencial viés ou opiniões não suportadas no ensaio."
...
class ExampleClarityTest(TestFunction):
    @property
    def name(self):
        return "example_clarity"

    @property
    def description(self):
        return "Avalia quão claros e ilustrativos são os exemplos."
...
class LogicalFallacyCheckTest(TestFunction):
    @property
    def name(self):
        return "logical_fallacy_check"

    @property
    def description(self):
        return "Verifica a presença de falácias lógicas comuns nos argumentos."
    ...
    def get_test(self, name: str) -> TestFunction:
        ...
        if not test_function:
            raise AttributeError(
                f"Teste '{name}' não encontrado no modelo '{self.template_name}'."
            )
