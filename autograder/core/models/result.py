...
from autograder.core.models.result_node import ResultNode, NodeType
...
class Result(BaseModel):
    ...
    def get_subject_tests(self, subject_name: str) ->  Optional[ResultNode]:
        node = self.get_subject_node(subject_name)
        return node.get_all_tests_results() if node else []
    

    def get_category_tests(self, category: str) -> Optional[ResultNode]:
    ...
    def get_navigation_path(self, node_name: str) -> Optional[List[ResultNode]]: 
        if not self.result_tree:
            return None
        return self.result_tree_get_node_path(node_name)
    ...
    def get_all_subjects(self) -> List[ResultNode] :
        ...
        for category in self.result_tree:
            subjects.extend(category.child)
