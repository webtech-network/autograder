...
try {
  ...
  recordResult('test_divide_by_zero', calc.divide(10, 0) === Infinity ? 'passed' : 'failed', '10 / 0 should be Infinity');
  ...
  fs.writeFileSync('./results/test_base_results.json', JSON.stringify(results, null, 2));
}