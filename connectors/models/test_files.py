...
class TestFiles:
    ...
    """
    def __init__(self,test_base=None,test_bonus=None,test_penalty=None,fatal_analysis=None,other_files=None):
        """
        ...
        :param fatal_analysis: Optional; the fatal tests file.
        ...
        self.fatal_analysis = fatal_analysis if fatal_analysis is not None else []
