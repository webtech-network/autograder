...
class TestFiles:
    ...
    def __init__(
        self, test_base=None, test_bonus=None, test_penalty=None, other_files=None
    ):
        """
    ...
    def __str__(self):
        test_base = test_bonus = test_penalty = fatal_tests = other_files = (
            "[Not Loaded]"
        )
        if self.test_base:
            test_base = "[Loaded]"
        ...
        if self.other_files:
            other_files = "[Loaded]"
        return (
            f"TestFiles(test_base={test_base}, test_bonus={test_bonus}, "
