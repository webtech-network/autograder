...
class Scorer:
    ...
    def set_base_score(self,filename):
        ...
        self.base_grader = Grader.create(f"grading/tests/{filename}",self.config.base_config)

    def set_bonus_score(self,filename):
        """Set the bonus score by creating a Grader instance for the bonus test file."""
        self.bonus_grader = Grader.create(f"grading/tests/{filename}",self.config.bonus_config)

    def set_penalty_score(self,filename):
        """Set the penalty score by creating a Grader instance for the penalty test file."""
        self.penalty_grader = Grader.create(f"grading/tests/{filename}",self.config.penalty_config)
